...
SELECT TO_CHAR(SALES_DATE,'YYYY-MM-DD') AS SALES_DATE , 
       ...
       SALES_AMOUNT
FROM ONLINE_SALE
WHERE SALES_DATE BETWEEN TO_DATE(20220301,'YYYY-MM-DD') 
  AND TO_DATE(20220331,'YYYY-MM-DD')
...
3) WHERE TO_CHAR(SALES_DATE, 'YYYYMM') = 202203
4) WHERE EXTRACT(YEAR FROM SALES_DATE) = 2022 AND EXTRACT(MONTH FROM SALES_DATE) = 3
네 번째 방법은 자유롭게 활용할 수 있을 떄까지 익혀둘 것
